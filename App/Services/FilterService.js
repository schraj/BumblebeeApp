...
const fuzzyHorned = { 
    ...
    category: 1, 
    bodySize: null,
    bodyParts: [null, 'Cloudy', 'Dark Band', 'Yellow', 'Yellow', 'Black', 'Black', 'Black', 'Red', 'Red'],
}
...
const yellowFaced = { 
    ...
    category: 2, 
    bodySize: null,
    bodyParts: ['Yellow', 'Yellow', 'Black', 'Black', 'Black', 'Black', 'Black', 'Yellow', 'Black', 'Black'],
}
...
const western = { 
    ...
    category: 1, 
    bodySize: null,
    bodyParts: ['Black', 'Golden', 'Black', 'Black', 'Black', 'Black', 'Black', 'White', 'White', 'White'],
}
...
const whiteShouldered = { 
    ...
    category: 3, 
    bodySize: 'Large',
    bodyParts: ['White', 'White', 'Black', 'Golden', 'Golden', 'Golden', 'Golden', 'Golden', 'Golden', 'Golden'],
}
...
const nevada = { 
    ...
    category: 4, 
    bodySize: null,
    bodyParts: ['Black', 'Golden', 'Black Dot', 'Golden', 'Golden', 'Golden', 'Golden', 'Black', 'Black', 'Black'],
}
...
const beeArray = [blackTail, central, hunts, fuzzyHorned, twoForm, yellowFaced, western, 
                   whiteShouldered, yellowHead, nevada, brownBelted]
...
export const filter = (attributeArray) => {
    ...
    beeArray.forEach(b => {
        ...
        for (let i=0; i<b.bodyParts.length; i++){
           if (attributeArray[i] !== null && attributeArray[i] !== b.bodyParts[i]){
               matched = false;
           }     
        }
        if (matched){
